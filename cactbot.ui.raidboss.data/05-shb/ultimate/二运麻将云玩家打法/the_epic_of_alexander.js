        ...
        data.namedNisiPass = (data) => {
          ...
          if (data.me in data.nisiMap) {
            ...
            return {
              ...
              cn: '将 ' + data.nisiNames[myNisi] + ' 毒传给 ' +
    ...
    },
    {
      ...
      infoText: function(data) {
        ...
        return {
          ...
          cn: '计数法点' + names.map((x) => data.ShortName(x)).join(', '),
        };
      },
    },
    {
    ...
    },
    {
      ...
      infoText: function(data, matches) {
        return {
          ...
          cn: '集团罪点->' + data.ShortName(matches.target),
        };
      },
    },
    {
      ...
      infoText: function(data, matches) {
        ...
        return {
          '004F': {
            ...
            ja: '右上 外向き 懺悔3回目',
            ko: '왼쪽 위 / 참회 #3',
            cn: '1号右下，注意齿轮，齿轮读条百分之75防击退，齿轮冲锋后贴边，踩灵泉#3',
          },
          '0050': {
            ...
            ja: '左下 内向き 懺悔3回目',
            ko: '오른쪽 위 / 참회 #3',
            cn: '2号左下，注意齿轮，齿轮读条百分之75防击退，齿轮冲锋后贴边，踩灵泉#3',
          },
          '0051': {
            ...
            ja: '左上',
            ko: '왼쪽 아래',
            cn: '3号右上，红点靠场地内侧引导超级跳，超级跳后贴边防击退，顺劈后躲避十字圣礼',
          },
          '0052': {
            ...
            ja: '右下',
            ko: '오른쪽 아래',
            cn: '4号左上，红点靠场地内侧引导超级跳，超级跳后贴边防击退，冲锋后躲避十字圣礼',
          },
          '0053': {
    ...
    },
    {
      ...
      infoText: function(data, matches) {
        ...
        return {
          ...
          cn: '靠近 ' + data.ShortName(matches.target) + '集合分摊',
